...
int main()
{
	...
	// -------------------------
	Shader shader("11.3.cube.vs", "11.3.cube.fs");
	Shader resolveShader("11.3.custom_resolve.vs", "11.3.custom_resolve.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// 2. custom AA to screen 
		glBindFramebuffer(GL_FRAMEBUFFER, 0);
		glClearColor(0.0f, 0.0f, 1.0f, 1.0f);
		glClear(GL_COLOR_BUFFER_BIT);
		glDisable(GL_DEPTH_TEST);			 // 最后上屏不用深度测试 

		CHECK_ERROR
		resolveShader.use();
		CHECK_ERROR
		glBindVertexArray(quadVAO);
		resolveShader.setInt("myTexture", 0);
